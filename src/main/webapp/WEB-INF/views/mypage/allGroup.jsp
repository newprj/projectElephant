		     ...
		     <div id="page-content">
				<div class="panel">
				     <div class="panel-heading">
				         <h3 class="panel-title">승인 요청 그룹</h3>
				     </div>
				     <div class="panel-body">
			              <table id="demo-dt-basic" class="table table-striped table-bordered">
			                  ...
			                  <tbody>
			                  <c:forEach items="${Nauth}" var="i" varStatus="status" >
			                      <tr>
			    ...
			    <div class="panel">
		          <div class="panel-heading">
		              <h3 class="panel-title">Authorized Group</h3>
		          </div>
		          <div class="panel-body">
		              <table id="demo-dt-selection" class="table table-striped table-bordered">
		                  <thead>
			                  ...
			                  <tbody>
				                  <c:forEach items="${group}" var="i" varStatus="status" >
				                      <tr>
				                          <td > <a href='/group/gather/${i.group_name}'>${i.group_name}</a></td>
				                          <td>${i.leader}</td>
				                          <td>${i.subject}</td>
